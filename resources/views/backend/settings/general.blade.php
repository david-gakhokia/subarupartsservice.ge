...
@section('content')
    <!-- Main Content -->
    <form method="POST" enctype="multipart/form-data" action="{{ route('restaurant.update') }}" class="needs-validation">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    @if ($mysetting->logo)
                                        <img src="{{ asset('uploads/settings/' . $setting->logo) }}" height="100"
                                            alt="{{ $setting->logo }}">
                                    @else
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    @if ($setting->image)
                                        <img style="background-color: #E77D6B"
                                            src="{{ asset('uploads/settings/' . $setting->image) }}" height="100"
                                            alt="{{ $setting->name }}">
                                    @else
                                        <img src="https://img.icons8.com/windows/100/000000/no-image.png" height="100" />
                                    @endif
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale }}[title]"
                                            @if ($setting) value="{{ $setting->translate($locale)->title }}" @endif
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale }}[name]"
                                            @if ($setting) value="{{ $setting->translate($locale)->name }}" @endif
                                            class="form-control marker">
                                        <div class="invalid-feedback">
                                            @lang('validation.Opss, This field is required')
                                        </div>
...
@endif
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale }}[address]"
                                            @if ($setting) value="{{ $setting->translate($locale)->address }}" @endif
                                            class="form-control marker">
                                    </div>
                                </div>
                            @endforeach
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                <div class="form-group col-md-3">
                                    <label style="color: rgba(5, 233, 43, 0.637)">@lang('dashboard.Start Time')
                                        ({{ strtoupper($locale) }})
                                    </label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="{{ $locale }}[start_time_text]"
                                            @if ($setting) value="{{ $setting->translate($locale)->start_time_text }}" @endif
                                            class="form-control marker">
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label style="color: rgba(233, 77, 77, 0.699)">@lang('dashboard.End Time')
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="{{ $locale }}[end_time_text]"
                                            @if ($setting) value="{{ $setting->translate($locale)->end_time_text }}" @endif
                                            class="form-control marker">
                                    </div>
                                </div>
                            @endforeach
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="time" name="start_time"
                                        @if ($setting) value="{{ $setting->start_time }}" @endif
                                        class="form-control">
                                    <input type="time" name="end_time"
                                        @if ($setting) value="{{ $setting->end_time }}" @endif
                                        class="form-control">
                                    <div class="invalid-feedback">
                                        @lang('validation.Opss, This field is required')
                                    </div>
