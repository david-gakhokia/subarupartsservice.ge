        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('users.create') }}" class="btn btn-icon icon-left btn-primary"><i
                            class="fas fa-plus"></i> @lang('dashboard.Add')</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped" id="table-1">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('dashboard.Restaurant')</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('users.show', $user->id) }}" class="btn btn-icon btn-info"
                                                users-toggle="tooltip" title="@lang('dashboard.View')">
                                                <i class="far fa-eye"></i>
                                            </a>
                                            @can('user-edit')
                                                <a href="{{ route('users.edit', $user->id) }}" class="btn btn-icon btn-primary"
                                                    users-toggle="tooltip" title="@lang('dashboard.Edit')">
