                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <img class="w-200" src="https://foodly.space/assets/images/logo.png"
                            style="display: block;
                            margin-left: auto;
                            margin-right: auto;"
                            width="200">
                            ...
                            <div class="space-y-4">
                              ...
                              <h1 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 26px; line-height: 26px; margin: 0;" align="center"> მაგიდა დაკავებული ყოფილა 😔</h1>
                              <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <tbody>
                                  <tr>
                                    <td style="line-height: 10px; font-size: 16px; width: 100%; height: 10px; margin: 0;" align="left" width="100%" height="10">
                                      &#160;
                                    </td>
                                  </tr>
                                </tbody>
                              ...
                              <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="center">
                                {{-- რესტორანში შენი შერჩეული მაგიდა დაკავებული ყოფილა 😔 <br> --}}
                                მაგრამ არ იდარდო! FOODLY-ზე ფართო არჩევანია, სადაც უამრავი შესანიშნავი რესტორანი შეგიძლია აღმოაჩინო!😊
                              </p>
                              <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <img class="w-200" src="https://foodly.space/assets/images/email/canceled.png"
                                style="display: block;
                                margin-left: auto;
                                margin-right: auto;"
                                width="200">
                                <tbody>
                                  <tr>
                                    <td style="line-height: 6px; font-size: 6px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="6">
                                      &#160;
                                    </td>
                                  </tr>
                                </tbody>
                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    <h3 class="text-center" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="center">რეზერვაციის დეტალები</h3>
                                    <p class="text-center text-muted" style="line-height: 24px; font-size: 18px; color: #000000; width: 100%; margin: 0;" align="center">ჯავშანი # : {{ $reservation->id }}</p>
                                    ...
                                    <table class="p-2 w-full" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                      <tbody>
                                        ...
                                        <tr>
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="left" width="100%">თარიღი:</td>
                                            <td class="text-right" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="right" width="100%">{{ $reservation->date }}</td>
                                            </tr>
                                        <tr>
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="left" width="100%">დრო:</td>
                                            <td class="text-right" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="right" width="100%">{{ $reservation->time }}</td>
                                            </tr>
                                        <tr>
                                          <td class="fw-700 border-top" style="line-height: 24px; font-size: 16px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;" align="left" width="100%">სტატუსი</td>
                                          {{-- <td class="fw-700 text-right border-top" style="line-height: 24px; font-size: 16px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;" align="right" width="100%">უარყოფილია</td> --}}
                                          <td class="fw-700 text-right border-top" style="line-height: 24px; font-size: 16px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%; font-weight: 700 !important; margin: 0; padding: 8px; color: red;" align="right" width="100%">უარყოფილია</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                    ...
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="center">კითხვების შემთხვევაში მოგვწერე <a href="mailto:info@foodly.space">✉️</a>
                                    </p>
                                    <h4 align="center" style="color: #EB644D;"> გმადლობა, რომ აირჩიე <a href="http://foodly.space" target="_blank" rel="noopener noreferrer">FOODLY</a></h4>
                                  </td>
