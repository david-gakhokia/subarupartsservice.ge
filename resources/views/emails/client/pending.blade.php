                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <h1 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 26px; line-height: 26px; margin: 0;" align="center">
                              ...
                              {{-- <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <img class="w-200" src="{{ asset('images/stickers/pending.png')}}"
                                style="display: block;
                                margin-left: auto;
                                margin-right: auto;"
                                width="200">
                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    ...
                                    <p class="text-center text-muted" style="line-height: 24px; font-size: 18px; color: #000000; width: 100%; margin: 0;" align="center">{{ __('ჯავშნის')}} ID # {{ $reservation->id }}</p>
                                    ...
                                    <table class="p-2 w-full" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                      <tbody>
                                        ...
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="left" width="100%">ივენთი:</td>
                                            <td class="text-right" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="right" width="100%">{{ $reservation->event_type }}{{ $reservation->other_event_type }}</td>
                                        </tr>
                                        <tr>
                                          <td class="fw-700 border-top" style="line-height: 24px; font-size: 16px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;" align="left" width="100%">საფასური</td>
                                          <td class="fw-700 text-right border-top" style="line-height: 24px; font-size: 16px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;" align="right" width="100%">{{ $reservation->price }} ₾</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                    ...
                                    <p style="line-height: 20px; color: #464746 ; font-size: 20px;  width: 100%; margin: 0;" align="center">შეამოწმე შემოთავაზება <a href="https://foodly.space/table/{{$reservation->place->id }}" target="_blank">🔎</a>
                                    </p>
